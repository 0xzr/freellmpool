...
Current catalog: 19 cataloged providers, 240 enabled chat routes, and 380 cataloged chat
models.
...
19 cataloged providers, 240 enabled chat routes, keyless start when routes are available.
