...
Current catalog: 24 cataloged providers, 247 enabled chat routes, and 405 cataloged chat
models.
...
24 cataloged providers, 247 enabled chat routes, keyless start when routes are available.
