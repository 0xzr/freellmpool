...
> Free LLM API pool: 19 LLM providers cataloged, 240 routes, 380 cataloged chat models, keyless start when available.
...
gh repo edit 0xzr/freellmpool \
  --description "Free LLM API pool: 19 LLM providers cataloged, 240 routes, 380 cataloged chat models, keyless start when available."
```
