...
> Free LLM API pool: 22 LLM providers cataloged, 239 routes, 397 cataloged chat models, keyless start when available.
...
gh repo edit 0xzr/freellmpool \
  --description "Free LLM API pool: 22 LLM providers cataloged, 239 routes, 397 cataloged chat models, keyless start when available."
```
